...
Регулярные выражения - это строки, которые задают шаблон для поиска данных. Любая строка может быть преобразована в регулярное выражение методом `.r`.
...
Используя круглые скобки можно объеденять сразу несколько групп регулярных выражений.
