...
A drop-in library replacement is provided in [`scala.util.control.NonLocalReturns`](https://scala-lang.org/api/3.x/api/scala/util/control/NonLocalReturns$.html). Example:
