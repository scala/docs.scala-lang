...
The [`scala.compiletime`](https://scala-lang.org/api/3.x/api/scala/compiletime.html) package contains helper definitions that provide support for compile-time operations over values. They are described in the following.
...
The [`scala.compiletime.ops`](https://scala-lang.org/api/3.x/api/scala/compiletime/ops.html) package contains types that provide support for
